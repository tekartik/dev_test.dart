...
void main() {
  group('filter_dart_project_options', () {
    test('filter_dart_project_options', () async {
      ...
      expect(
          options
              .matchesBoundaries(VersionBoundaries.version(Version(1, 0, 0))),
          isTrue);
      expect(
          options
              .matchesBoundaries(VersionBoundaries.version(Version(0, 0, 0))),
          isFalse);
      ...
      expect(
          options
              .matchesBoundaries(VersionBoundaries.version(Version(2, 0, 0))),
          isFalse);
      options = FilterDartProjectOptions(
      ...
      expect(
          ...
          isFalse);
      options = FilterDartProjectOptions(
          minSdk: VersionBoundaries(VersionBoundary(Version(1, 0, 0), true),
              VersionBoundary(Version(2, 0, 0), false)),
          maxSdk: VersionBoundaries(VersionBoundary(Version(3, 0, 0), false),
      ...
      expect(
          options
              .matchesBoundaries(VersionBoundaries.parse('>=2.0.0-0 <=3.0.1')),
          isTrue);
      expect(
      ...
      expect(
          options
              .matchesBoundaries(VersionBoundaries.parse('>=2.0.0-0 <=3.0.0')),
          isFalse);
    });
  });
}
